...
### FileProductionOptions 

Functionality: **_Exploration - File production and move options - basic_**
...
Git clone the xbf_FileProductionOptions project into your workspace:

_from your bash shell:_

```bash
cd yourworkspacedirectory
git clone https://github.com/jammazwan/xbf_FileProductionOptions.git
cd xbf_FileProductionOptions
mvn install -DskipTests

```

You man now import xbf_FileProductionOptions into your IDE.
...
_run each specific test seperately, also see NOTES.md_
